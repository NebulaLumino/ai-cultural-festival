    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-950 to-gray-900 text-white flex flex-col">
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-16">
        <div className="w-full max-w-2xl">
          <h1 className="text-3xl font-bold mb-2">AI Cultural Festival</h1>
          <p className="text-gray-400 mb-8">Design cultural festivals celebrating heritage with community and scale in mind.</p>
          <form onSubmit={handleGenerate} className="space-y-4">
            <div>
              <label className="block text-sm text-gray-400 mb-1">Cultural Heritage</label>
            ...
            <div>
              <label className="block text-sm text-gray-400 mb-1">Event Scale</label>
            ...
            <div>
              <label className="block text-sm text-gray-400 mb-1">Target Participants</label>
            ...
            <div>
              <label className="block text-sm text-gray-400 mb-1">Community Values</label>
            ...
            <button type="submit" disabled={loading} className="w-full py-3 rounded-lg font-semibold text-white disabled:opacity-50 bg-green-600">
              {btnLabel}
            </button>
          </form>
          {output && (
